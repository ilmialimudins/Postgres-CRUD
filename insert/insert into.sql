...
-- alter table countries rename column coutry_name to country_name
...
-- alter table locations rename column state_provience to state_province
...
-- alter table jobs rename column job_titte to job_title
...
-- alter table employees rename column commission to commission_pct
...
-- insert into employees (employee_id,first_name,last_name,email,phone_number,hire_date,salary,commission_pct,job_id,manager_id,department_id) values('207','Muhammad Ilmi','Alimudin','muhammad@outlook.com','08221512542','2004-02-17','77000','99000','207','101','40');
